...
<div class="row">
    ...
    <li>
      <div class="collapsible-header"><i class="mdi-communication-message"></i>Ray Stoneham</div>
    ...
    <li>
      <div class="collapsible-header"><i class="mdi-communication-message"></i>Keeran Jamil</div>
